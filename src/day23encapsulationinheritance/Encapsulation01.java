...
public class Encapsulation01 {
	...
	// Make "address" just updatable, you should not create "getter", you should
	// create "setter"
	 ...
	 * Question:How can you make a class "immutable class"? Answer: Make all
	 * variables private then do not create any setter method
	 */
