...
public class IfElseStatement04 {
	...
	private static void topOrcarp() {
		// TODO Auto-generated method stub
		Scanner scan = new Scanner(System.in);
		System.out.println("Please enter 2 again  integers..");

		int a = scan.nextInt();
		int b = scan.nextInt();
		
		if (a>=0 && b>=0) {
			System.out.println(" toplam result "+(a+b));
		}else if (a<0 && b<0) {
			
			System.out.println(" carpma result negatif olduklari icin "+(a*b));
		}else if (a==0 && b==0) {
			
			System.out.println(" 0 olan sayilarin toplami : "+(a+b));
		}else {
			System.out.println(" i cannot add or multiply  different signed numbers ");
		}
	}
