...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		//first index is inclusie,second index is exclusive
		String a=str1.substring(3,6);
		...
		//19)trim()
		//trim() is used for remove space character Just from the beginnng and from end of the String
		String str2="  Java is Java ";
		System.err.println(str2.length());//15
		...
		System.out.println(firstname.concat(" ").concat(surname));//Ayse KAYA
