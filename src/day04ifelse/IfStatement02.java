...
public class IfStatement02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Type java code by using if statement When you enter the initial of the day of
		 * a week, output should be all possible names of the days For example;if the
		 * initial is 'S' output should be "Saturday and Sunday" Get the initial from
		 * user; M,T,W,T,F,S,S
		 */
