...
public class StringBuilder01 {
	/*
	 * To create "mutable Strings" Java created String Builder class. If you create
	 * a String by using String Builder class, the String is going to be "mutable"
	 */
	public static void main(String[] args) {
		...
		System.out.println(sb4+" ne cikti sonuc ");

		sb4.reverse();
		System.out.println(sb4+" ters dondurme ");// ekilXXXXXciliK
