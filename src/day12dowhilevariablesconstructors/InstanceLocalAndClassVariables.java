    ...
    /*
     ...
     ->To access instance variables you need to create an object
       ...
       You can not access  instance variables by class name
         ...
         Default values: bu degerlerin dogal atanma olmadan onceki degerleri 
         ...
         For String default value is null // String icin  null dogal bir deger ama  "" bu da onu bos olarak gostermek ama kendimiz atama yapmisiz 
     ...
     Note: The main differences between static(class) variables and instance (object) variables is that
          ...
          a)All updates on a static variable is visible by all objects which are created from class  
         
          but all  updates  on an instance variables is visible just by only object
