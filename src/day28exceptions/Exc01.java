...
public class Exc01 {
	 ...
	 *                                       
	 *  try + finally==>It means you do not want to handle exception but you want to do sth
	 *  				like ending connection with database at the end	
	 *  
	 * 	try + catch + finally==>  It means you want do handle exception and you want to do sth like 
	 * 								ending connection with database at the end
	*/
