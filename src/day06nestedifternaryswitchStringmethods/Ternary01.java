...
public class Ternary01 {
	...
	public static void main(String[] args) {
		...
		int a = scan.nextInt();
//First Question		
//Condition     Question Mark Code will be excuted if the condition is true Colon will be excutedif the condition is false
//	a%2==0 	         ?            "The integer is even"                        :      "The integer is even"
		...
		// 2.wAY:
		// a%2==0 ?System.out.println("The integer is even"):System.out.println("The
		// integer is odd");
		System.out.println(result1);
