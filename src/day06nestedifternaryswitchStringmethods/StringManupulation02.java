...
public class StringManupulation02 {
	...
	public static void main(String[] args) {
		...
		// If you use indexOf() with 2 parameters, Java looks for the character after
		// the given index.
...
//		System.out.println(result);
		 ...
		 * exist in the String or exists just once, print "Not good!" If the character
		 * is used multiple times print "Wooow!".
		 */
//		System.out.println("Enter a String the enter a character");
//		String s = scan.nextLine();
//		char ch = scan.next().charAt(0);
