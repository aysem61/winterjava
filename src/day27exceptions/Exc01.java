...
public class Exc01 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(s2.length());//NullPointerException:If you try do un appropriate actions with
										//	a "null" 	you will get	"NullPointerException"				
		...
		System.out.println(b+2);//NumberFormatException:If you want to convert non-digit Strings to Integer
