...
public class Varargs01 {
	 ...
	 * 2)varargs behaves like lists but behind the varargs arrays work 3)To declare
	 * a varargs use "int... a" or "String... s" etc. 4)varargs must be the last
	 * parameter inside the method parenthesis 5)Can I use multiple varargs inside a
	 * method parenthesis
	 */
